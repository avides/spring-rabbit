...
@ActiveProfiles({ "it", "beforePublishPostProcessor", "beforePublishPostProcessorAppIdEnricherWithConfiguredAppId" })
public class SpringRabbitAutoConfigurationWithBeforePublishPostProcessorAppIdEnricherWithConfiguredAppIdIT extends AbstractIT
{
    @Autowired
